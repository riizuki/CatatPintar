      ...
      <div className="container mx-auto px-6 md:px-32 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start space-x-4"> {/* Using flex for icons */}
              <a href="#" className="text-gray-500 hover:text-[#4CC1EE] transition-colors duration-500">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 text-center text-sm text-gray-400 transition-colors duration-500"> {/* Adjusted border color */}
          <p className="transition-colors duration-500">
            &copy; {new Date().getFullYear()} CatatPintar. All rights reserved.
          </p>
          <p className="mt-1 transition-colors duration-500">Dibuat oleh Kelompok 5</p> 
        </div>
      </div>
    </footer>
  );
